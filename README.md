...
- Court demand — same repo for now, under `pickleball/`, on the `claude/pickleball-demand-prediction-4dhb13` branch. It wants its own repository; when it gets one, repoint the four GitHub links in `pickleball-court-demand.html`.
